...
pub fn redirect_credential_to_ffi(value: RedirectCredential) -> ffi::RedirectCredential {
    match value {
        RedirectCredential::Unspecified => ffi::RedirectCredential::Unspecified,
        RedirectCredential::None => ffi::RedirectCredential::None,
        RedirectCredential::Request => ffi::RedirectCredential::Request,
        RedirectCredential::Connection => ffi::RedirectCredential::Connection,
    }
}

pub fn redirect_credential_from_ffi(value: ffi::RedirectCredential) -> RedirectCredential {
    match value {
        ffi::RedirectCredential::Unspecified => RedirectCredential::Unspecified,
        ffi::RedirectCredential::None => RedirectCredential::None,
        ffi::RedirectCredential::Request => RedirectCredential::Request,
        ffi::RedirectCredential::Connection => RedirectCredential::Connection,
    }
}
...
pub fn redirect_scope_to_ffi(value: RedirectScope) -> ffi::RedirectScope {
    ffi::RedirectScope {
        ...
        credential: redirect_credential_to_ffi(value.credential),
    }
}
...
pub unsafe fn redirect_scope_from_ffi(value: ffi::RedirectScope) -> Result<RedirectScope, Error> {
    unsafe {
        ...
        let credential = redirect_credential_from_ffi(value.credential);
