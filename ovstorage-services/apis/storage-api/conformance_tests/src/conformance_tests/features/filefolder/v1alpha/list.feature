Feature: List() and ListStat(), FileFolderAPI
  ...
  Background:
    Given a new test namespace called 'liststat_test_alpha'
  ...
  Scenario Outline: List and ListStat of a directory-like resource address using GRPC with lots of entries works
    ...
    And the 'GRPC' service supports the 'filefolder' API in version 'v1alpha' for feature 'filefolder'
  ...
  Scenario Outline: List and ListStat of a directory-like resource address using REST with lots of entries works
    ...
    And the 'REST' service supports the 'filefolder' API in version 'v1alpha' for feature 'filefolder'
  ...
  Scenario Outline: List of a subtree works and respects folder delimiter
    ...
    And the '<method>' service supports the 'fileobject' API in version 'v1alpha' for feature 'fileobject'
    And the '<method>' service supports the 'filefolder' API in version 'v1alpha' for feature 'filefolder'
