...
//! URL *query*, which is part of the resolved address, not `if_match`. It is
//! the query and not the fragment that carries this: canonicalization drops a
//! fragment, and keeps the query precisely because a pin selects a different
//! node.
//!
