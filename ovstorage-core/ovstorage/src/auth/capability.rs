...
//! Resolve [`InteractiveAuthCapability`] for host credential flows.
//!
//! Precedence: explicit host configuration > env var
//! (`OV_INTERACTIVE_AUTH_CAPABILITY=browser|headless|none`) > smart default.
//! Invalid env values warn + fall through rather than failing startup.
//!
