...
impl SowsTransport {
    ...
    async fn connect_inner(url: &str) -> Result<Self> {
        ...
        info!(conn_id = %conn_id, url, "connecting");
                ...
                Some(Ok(Message::Binary(data))) => {
                    ...
                    match resp_type {
                        ...
                        RESPONSE_SEND => {
                            ...
                            trace!(conn_id = %conn_id, id, json_len, blob_len, json = %json_preview, "received response");
    ...
    fn build_request_frame(
        ...
        let params_preview = String::from_utf8_lossy(&params_bytes);
        trace!(conn_id = %self.conn_id, id, interface, method, params_len = params_bytes.len(), blob_len, params = %params_preview, "sending request");
